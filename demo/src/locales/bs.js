...
const messages=defineMessages({
  ...
  link_with_google: 'Sa Google povezati',
  link_with_facebook: 'Sa Facebookom povezati',
  link_with_twitter: 'Sa Twitterom povezati',
  link_with_github: 'Sa Githubom povezati',
